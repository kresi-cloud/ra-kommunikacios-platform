...
| I1/B2a | Létrehozás, adatlapok, Kanban, résztvevők és elfoglaltság | Implementálva; CI-ellenőrzésre kész |
| I1/B2b | Határidő-/felelősszerkesztés, esemény átütemezés/lemondás, Kanban drag-and-drop | Következő |
...
1. Feladathatáridő módosítása kötelező indoklással, feladatátadás új elfogadással.
2. Esemény átütemezése és lemondása, fontos változásnál visszaigazolás-reset.
3. Kanban drag-and-drop kizárólag engedélyezett átmenetekre.
4. Értesítési outbox alap, külső szolgáltató nélkül.
